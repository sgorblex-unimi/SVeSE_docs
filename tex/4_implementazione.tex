...
L'admin ha accesso anche ad un'interfaccia che consente di operare direttamente sulla sessione, mettendola pronta per essere approvata o forzando lo stop (vedi fig. \ref{screenshot:sessionmanagement}).
\begin{figure}
	\centering
